...
| 层级 | 技术 | 说明 |
| --- | --- | --- |
| 前端 | Next.js + App Router | Web Workbench 框架 |
| 前端 | Tailwind CSS + Shadcn/ui | UI 样式和组件库 |
| 前端 | Vercel AI SDK | 与 AI Agent 交互 |
| 前端 | TypeScript | 类型安全开发 |
| 后端 | FastAPI | 提供统一 API，管理前端请求 |
| 编排 | LangGraph | Agent 编排与路由，Memory + Checkpoint 管理 |
| 模型 | DeepSeek (OpenAI SDK) | 核心生成能力 |
| 知识库 | ChromaDB | 向量数据库，实现 RAG |
| 数据存储 | sqlite | 存储元数据、索引和文档引用 |
| 其他 | MockKnowledgeProvider | 测试/本地开发使用 |
---
